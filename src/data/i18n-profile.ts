...
export const profileData: Record<string, ProfileData> = {
  en: {
    infor: {
      information:
        "Passionate Full Stack Developer from Cambodia with strong experience in Vue.js and modern JavaScript frameworks. Currently upskilling in React, Next.js, Expo (React Native), Supabase, Telegram Bot development, and backend systems using Express.js. Focused on building scalable web and mobile applications.",
    },
    skills: [
      {
        title: "Frontend",
    ...
    projects: [
      {
        title: "Angkor Homestay",
        desc: "A website for booking homestay in Siem Reap",
        tags: [
          "Nuxt",
          "Tailwindcss",
          "Responsive Web",
      ...
      {
        title: "School Management integrate Chat Bot",
        desc: "A school management system integrated with a Chat Bot to send notifications to students and parents",
        tags: [
          "Vue",
          "primevue",
          "Responsive Web",
  ...
  km: {
    ...
    projects: [
      {
        title: "Angkor Homestay",
        desc: "គេហទំព័រសម្រាប់កក់ Homestay ក្នុងខេត្តសៀមរាប",
        tags: [
          "Nuxt",
          "Tailwindcss",
          "Responsive Web",
      ...
      {
        title: "School Management integrate Chat Bot",
        desc: "ប្រព័ន្ធគ្រប់គ្រងសាលារៀនដែលភ្ជាប់ជាមួយ Chat Bot ដើម្បីផ្ញើសារជូនដំណឹងទៅកាន់សិស្ស និងអាណាព្យាបាល",
        tags: [
          "Vue",
          "primevue",
          "Responsive Web",
  ...
  zh: {
    ...
    projects: [
      ...
      {
        title: "School Management integrate Chat Bot",
        desc: "集成 Chat Bot 的学校管理系统，向学生和家长发送通知",
        tags: [
          "Vue",
          "primevue",
          "Responsive Web",
  ...
  vi: {
    ...
    projects: [
      {
        title: "Angkor Homestay",
        desc: "Trang web đặt phòng homestay tại Siem Reap",
        tags: [
          "Nuxt",
          "Tailwindcss",
          "Responsive Web",
      ...
      {
        title: "School Management integrate Chat Bot",
        desc: "Hệ thống quản lý trường học tích hợp Chat Bot để gửi thông báo cho học sinh và phụ huynh",
        tags: [
          "Vue",
          "primevue",
          "Responsive Web",
